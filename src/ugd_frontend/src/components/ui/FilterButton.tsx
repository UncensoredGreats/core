...
export default function FilterButton() {
	...
	return (
		<button
			...
			className={`absolute md:static cursor-pointer w-auto md:w-40 h-auto font-syne font-bold flex justify-left items-center gap-2.5 p-2 md:p-4 md:border md:border-solid md:border-black rounded-3xl  ${
				filter
		...
		>
			...
			<span className="hidden md:block text-2xl leading-7 text-center tracking-wider">
				Filter
			</span>
		</button>
	);
